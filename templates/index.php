...
<?php $_COOKIE['Name'];?>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <div class="hero-wrap" style="background-image: url('{{ url_for('static', filename='css/images/diabetes.png') }}'); background-attachment:fixed;">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h3 class="mb-3 bread">Diabetes-Department</h3>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container col-lg-6" >
            ...
            <div class="w3-card-4" style="width: 550px;">
              <div class="w3-container w3-black">
                <h2 style="color:white;">DiabetesAnalysis</h2>
              </div>
